...
The Manjappada Fans Group are the most Active & biggest fan group of KBFC Awarded As the Best Fans Of The Year  2017 & 2020 by Indian Sports Honour 🏆 
...
if START_IMG is None:
    img = "https://telegra.ph/file/f2a8f5091660582907966.png"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="👥Admins",url="https://t.me/ManjappadaRobot"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/Siyad")]]
    keyboard += [[InlineKeyboardButton(text="💛Join Group",url="https://t.me/Kbfcmanjappada"),InlineKeyboardButton(text="🔈Channel Group",url="https://t.me/Kbfc_manjappada".format(bot.username))]]
